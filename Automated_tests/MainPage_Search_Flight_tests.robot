...
TC_03_01-Ryanair_MainPage_Check_If_Flight_Search_Is_Present
  Check If Search Flight Is Present  Zpáteční let

TC_03_02-Ryanair_MainPage_Flight_Search_Empty_Airports
  Search Flight With Empty Airports  Vyberte z

TC_03_03-Ryanair_MainPage_Flight_Search_Empty_Destination_Airport
  Search Flight With Empty Destination Airport  Vyberte destinaci

TC_03_04-Ryanair_MainPage_Flight_Search_Empty_Travel_Dates
  Search Flight With Empty Travel Dates  Vyberte termín cesty

TC_03_05-Ryanair_MainPage_Flight_Search_Empty_Return_Date
  Search Flight With Empty Return Date  Vyberte termín cesty

TC_03_06-Ryanair_MainPage_Flight_Search_Flight_With_Valid_Attributes
  Search Flight With Valid Attributes  Ostrava do Malaga

TC_03_07-Ryanair_MainPage_Flight_Search_One_Way_Flight_No_Return_Date_Present
  Go Back
...
TC_03_08-Ryanair_MainPage_Flight_Search_Promo_Code
